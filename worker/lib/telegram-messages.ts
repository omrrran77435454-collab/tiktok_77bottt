 ...
 * ملاحظة: لا رسالة هنا تطلب الاشتراك أو تجعله شرطاً؛ القناة دعوة لا بوابة.
 */
  ...
  welcome: (env: MessageEnv) =>
    withChannelFooter(
      ...
      '👋 مرحباً بك في <b>أدوات المعلم</b>\n\n' +
        'المنصّة مفتوحة لك بمجرّد تسجيل الدخول — لا تحتاج ربطاً ولا اشتراكاً.\n' +
        'وإن رغبت في ربط حسابك بتيليجرام، افتح الموقع ثم اضغط زر «ربط Telegram».',
    ),

  /** ربط ناجح. الاشتراك اختياري فلا نطلبه ولا نشترطه. */
  linked: (env: MessageEnv) =>
    withChannelFooter(
      env,
      '✅ <b>تم ربط حسابك بنجاح</b>\n\n' +
        'يمكنك استخدام أدوات المنصّة كاملةً — ارجع إلى الموقع.',
    ),
