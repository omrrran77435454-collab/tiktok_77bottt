...
/**
 * مستخدم جاهز تماماً: مسجّل + مُهيّأ، ومربوط بتيليجرام أيضاً.
 *
 * الربط هنا ليس شرطاً للوصول (البوابة أُزيلت) — نُبقيه لأنه يمثّل المستخدم
 * الذي فعّل الميزة الاختيارية، فتغطّي المواصفات الحالة الكاملة.
 * التهيئة مُكمَلة افتراضياً؛ مرّر skipOnboarding لاختبار معالج التهيئة نفسه.
 */
