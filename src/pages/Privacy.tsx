      ...
      <article className="legal-page">
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            إلى خوادمنا ولا إلى Google ولا إلى Telegram. ما نحفظه على الخادم هو حسابك وتفضيلاتك
        ...
        <section className="legal-section">
          ...
          <ul className="legal-list">
            ...
            <li>
              <strong>معرّف Telegram الرقمي واسم المستخدم:</strong> فقط إن اخترت ربط حسابك — والربط
              اختياري ولا يؤثّر في وصولك.
            </li>
            <li>
        ...
        <section className="legal-section">
          ...
          <ul className="legal-list">
            ...
            <li>
              <strong>Telegram:</strong> فقط إن اخترت ربط حسابك. نرسل معرّفك الرقمي إلى البوت
              لإتمام الربط، ولا نرسل أي بيانات طلاب.
            </li>
          </ul>
        </section>
