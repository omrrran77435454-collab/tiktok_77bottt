...
const FAQ = [
  {
    question: 'لماذا يُطلب مني ربط حساب Telegram؟',
    answer:
      'الأدوات متاحة لمشتركي القناة. الربط يتم بضغطة واحدة عبر البوت، ولا نطلب منك كتابة أي معلومة يدوياً، ولا نستطيع الوصول إلى محادثاتك.',
  },
  {
    question: 'انتهت صلاحية رابط الربط، ماذا أفعل؟',
    answer:
      'رابط الربط صالح 10 دقائق فقط لأسباب أمنية. ارجع إلى صفحة الربط واضغط «ربط Telegram» مرة أخرى للحصول على رابط جديد.',
  },
  {
    question: 'اشتركت في القناة لكن النظام يقول إن الاشتراك غير مؤكّد',
    answer:
      'تأكّد أنك اشتركت بنفس حساب تيليجرام الذي ربطته. إن كان الحساب صحيحاً، انتظر ثوانٍ ثم اضغط «تحقق من الاشتراك» مجدداً.',
  },
  {
    ...
    <div className="container page-section">
      ...
      <div className="card" style={{ marginBlockStart: 'var(--sp-8)' }}>
        ...
        <p className="muted small" style={{ marginBlockStart: 'var(--sp-2)' }}>
          راسلنا عبر قناة المنصة على تيليجرام، أو ارجع إلى <Link to="/connect">صفحة الربط</Link>{' '}
