      ...
      <article className="legal-page">
        ...
        <section className="legal-section">
          ...
          <ul className="legal-list">
            ...
            <li>لا تحاول تجاوز قيود الوصول أو التحقّق من الاشتراك.</li>
        ...
        <section className="legal-section">
          <h2 className="title-sm">شرط الاشتراك في القناة</h2>
          <p>
            فتح الأدوات يتطلّب ربط حساب Telegram والاشتراك في قناة المنصّة. إن ألغيت اشتراكك، قد
            يتوقّف وصولك إلى الأدوات عند إعادة التحقّق الدورية.
          </p>
        </section>
